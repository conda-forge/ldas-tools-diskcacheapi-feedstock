About ldas-tools-diskcacheapi-feedstock
=======================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ldas-tools-diskcacheapi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ldas-tools-diskcacheapi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add ldas-tools-diskcacheapi
# for installing globally
pixi global install ldas-tools-diskcacheapi
```
...
It is possible to list all of the versions of `ldas-tools-diskcacheapi` available on your platform:
...
```
pixi search ldas-tools-diskcacheapi --channel conda-forge
```
